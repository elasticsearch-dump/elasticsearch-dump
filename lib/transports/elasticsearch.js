...
elasticsearch.prototype.setData = function(data, limit, offset, callback){
    ...
    if (self.parent.options.bulk === true){
        ...
        data.forEach(function(elem, index, theArray) {
            ...
            val += "\"_id\" : \""    + elem._id    + "\"";
            if (elem.fields && elem.fields._parent && elem.fields._routing) {
              val += ", " + "\"_parent\" : \""  + elem.fields._parent
                   + ", " + "\"_routing\" : \"" + elem.fields._routing;
            }
            val += " } }\n";
        ...
        data.forEach(function(elem){
            ...
            if (elem.fields && elem.fields._parent && elem.fields._routing) {
              thisURL += "?parent="  + encodeURIComponent(elem.fields._parent)
                       + "&routing=" + encodeURIComponent(elem.fields._routing);
            }
            var payload = {
                url:  thisUrl,
