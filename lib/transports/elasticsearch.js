...
elasticsearch.prototype.setData = function (data, limit, offset, callback) {
  ...
  data.forEach(function (elem) {
    ...
    payload.body += jsonParser.stringify(actionMeta) + '\n'
    payload.body += jsonParser.stringify(elem._source) + '\n'
  })

  self.parent.emit('debug', 'thisUrl: ' + thisUrl + ', payload.body: ' + jsonParser.stringify(payload.body))
