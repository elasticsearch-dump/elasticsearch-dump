...
class Data {
  async getData (limit, offset, callback) {
    ...
    if (this.lastScrollId !== null) {
      ...
      const additionalParams = this.paramsToString(this.parent.options.scrollParams || this.parent.options.params, '&')
  ...
  setData (data, limit, offset, callback) {
    ...
    const additionalParams = this.paramsToString(this.parent.options.indexParams || this.parent.options.params)
